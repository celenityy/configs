...
user_pref("browser.celenity.status.osx.discord", "001");
...
user_pref("browser.celenity.status.osx.discord", "002");
...
user_pref("browser.celenity.status.osx.discord", "003");
...
user_pref("browser.celenity.status.osx.discord", "004");
...
user_pref("browser.celenity.status.osx.discord", "005");

user_pref("browser.celenity.status.osx.discord", "successfully applied :D");
