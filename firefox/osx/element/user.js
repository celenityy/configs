...
user_pref("browser.celenity.status.osx.element", "000");
...
user_pref("browser.celenity.status.osx.element", "001");
...
user_pref("browser.celenity.status.osx.element", "002");
...
user_pref("browser.celenity.status.osx.element", "003");
...
user_pref("browser.celenity.status.osx.element", "004");
...
user_pref("browser.celenity.status.osx.element", "005");

user_pref("browser.celenity.status.osx.element", "successfully applied :D");
