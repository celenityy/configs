...
user_pref("browser.celenity.status.osx.twitter", "001");
...
user_pref("browser.celenity.status.osx.twitter", "002");
...
user_pref("browser.celenity.status.osx.twitter", "003");
...
user_pref("browser.celenity.status.osx.twitter", "004");
...
user_pref("browser.celenity.status.osx.twitter", "005");

user_pref("browser.celenity.status.osx.twitter", "successfully applied :D");
