...
/// Use Phoenix's Element specialized config
user_pref("autoadmin.global_config_url", "file:///etc/firefox/phoenix/configs/element.cfg");

user_pref("browser.celenity.status.linux.element", "000");
...
user_pref("browser.celenity.status.linux.element", "001");
...
user_pref("browser.celenity.status.linux.element", "002");
...
user_pref("browser.celenity.status.linux.element", "003");
...
user_pref("browser.celenity.status.linux.element", "004");
...
user_pref("browser.celenity.status.linux.element", "005");

user_pref("browser.celenity.status.linux.element", "successfully applied :D");
