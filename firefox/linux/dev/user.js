...
/// Add Codeberg, GitLab, and GitHub to `about:home`
user_pref("browser.newtabpage.pinned", '[{"url":"https://codeberg.org/","label":"Codeberg","baseDomain":"codeberg.org"},{"url":"https://github.com/","label":"GitHub","baseDomain":"github.com"},{"url":"https://gitlab.com/","label":"GitLab"}]');
...
user_pref("browser.celenity.status.linux", "001");

/*** 002 DNS ***/

/// Use NextDNS
user_pref("network.trr.bootstrapAddr", "45.90.28.0");
user_pref("network.trr.uri", "https://firefox.dns.nextdns.io/[XXXXXX]/Linux%20Dev");
...
user_pref("browser.celenity.status.linux", "003");
...
user_pref("browser.celenity.status.linux", "004");
...
user_pref("browser.celenity.status.linux", "005");

/*** 006 MISC. ***/

/// Set default permissions
user_pref("permissions.manager.defaultsUrl", "file:///home/user/firefox/dev/permissions");

user_pref("browser.celenity.status.linux", "006");

user_pref("browser.celenity.status.linux", "successfully applied :D");
